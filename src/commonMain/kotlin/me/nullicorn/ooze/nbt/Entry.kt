...
data class Entry internal constructor(
     ...
     */
    val byteValue = asType<Byte>(Type.BYTE)
     ...
     */
    val shortValue = asType<Short>(Type.SHORT)
     ...
     */
    val intValue = asType<Int>(Type.INT)
     ...
     */
    val longValue = asType<Long>(Type.LONG)
     ...
     */
    val floatValue = asType<Float>(Type.FLOAT)
     ...
     */
    val doubleValue = asType<Double>(Type.DOUBLE)
     ...
     */
    val byteArrayValue = asType<ByteArray>(Type.BYTE_ARRAY)
     ...
     */
    val intArrayValue = asType<IntArray>(Type.INT_ARRAY)
     ...
     */
    val longArrayValue = asType<LongArray>(Type.LONG_ARRAY)
     ...
     */
    val stringValue = asType<String>(Type.STRING)
     ...
     */
    val listValue = asType<TagList>(Type.LIST)
     ...
     */
    val compoundValue = asType<TagCompound>(Type.COMPOUND)
